...
#▬▭▬▭▬▭▬▭[INFO]▬▭▬▭▬▭▬▭#
def main_logo():
   os.system("xdg-open https://t.me/+PbXthALmtKM5ZDRk");os.system("clear" if os.name == "posix" else "cls");print(logo);linex();print(info);linex()
#▬▭▬▭▬▭▬▭[LOOP]▬▭▬▭▬▭▬▭#
